...
export const HONOR_SCHOLARSHIPS: ScholarshipCategory[] = [
  {
    ...
    min:      3.51,
    max:      4.00,
    minGrade: 'No grade below 2.5',
    benefits: ['100% Total Assessment (net of personal items)', '₱1,000 worth of textbooks (board courses only)'],
    color: {
  ...
  },
  {
    ...
    max:      3.50,
    minGrade: 'No grade below 2.5',
    benefits: ['75% Total Assessment (net of personal items)', '₱1,000 worth of textbooks (board courses only)'],
    color: {
  ...
  },
  {
    ...
    max:      3.26,
    minGrade: 'No grade below 2.5',
    benefits: ['50% Total Assessment (net of personal items)'],
    color: {
