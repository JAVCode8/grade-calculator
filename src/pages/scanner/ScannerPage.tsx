...
const HOW_TO_DESKTOP_MODE = [
  ...
  },
  {
    ...
    steps:  'Go to iPhone Settings → Apps → Safari → Request Desktop Website → Toggle ON "All Websites"',
  },
  {
...
export default function ScannerPage() {
  ...
  // ── Hoisted first before any useCallback that uses it ──
    ...
    <div className="flex flex-col gap-6">
      ...
      <div>
        ...
        <p className="text-xs text-warm-400 mt-0.5">
          Upload one or more screenshots of your UMDC Student Portal to
            ...
            <div className="flex flex-col items-center justify-center py-10 px-6 text-center">
              ...
              <p className="text-sm font-semibold text-warm-800 mb-1">
                {isDragging
                  ...
                  : 'Drop your portal screenshots here'}
              </p>
              <p className="text-xs text-warm-400 mb-4">
                or click to browse — you can upload multiple screenshots
              </p>
            ...
            <div className="flex flex-col gap-3">
              ...
              <div className="flex items-center justify-between">
                <p className="text-sm font-semibold text-warm-800">
                  {images.length}{' '}
                  {images.length === 1 ? 'screenshot' : 'screenshots'} uploaded
                </p>
              ...
              >
                <ScanLine size={16} />
                Scan & Extract Grades ({images.length}{' '}
            ...
            <div className="px-4 py-3">
              ...
              <div className="flex flex-col gap-2">
                {HOW_TO_DESKTOP_MODE.map(item => (
                  <div
                    key={item.device}
                    className="px-3 py-2 bg-warm-50 border border-blush rounded-lg"
                  >
          ...
          <div className="bg-white rounded-xl border border-blush shadow-warm-sm overflow-hidden">
            ...
            <div className="px-4 py-3">
              <p className="text-[10px] text-warm-500 mb-2 leading-relaxed">
                Your screenshot should look like this — all columns visible:
              </p>
              {/* Mock table preview */}
